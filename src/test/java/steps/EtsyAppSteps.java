    ...
    public void userValidatesThatItemPricesAreOverDollars(String filterRange) throws InterruptedException {
        ...
        if (filterRange.equals("over 1500")) {
            ...
            for (WebElement element : prices) {
                ...
                String priceStr = element.getText().replace(",", ""); //getting rid of coma
                double actualPriceDbl = Double.parseDouble(priceStr);
                System.out.println(actualPriceDbl);

                String expectedPrice = filterRange.substring(filterRange.indexOf(" ") + 1);//for examples in table
            ...
            for (WebElement element : prices) {
                ...
                String expectedPrice2 = filterRange.substring(filterRange.indexOf(" ") + 1); //750
                double expectedPriceDb2 = Double.parseDouble(expectedPrice2);

                Assert.assertTrue(actualPriceDbl >= expectedPriceDbl1 && actualPriceDbl <= expectedPriceDb2);
                //1920.00>=250.00
            ...
            for (WebElement element : prices) {
                ...
                Assert.assertTrue(actualPriceDbl >= expectedPriceDbl1 && actualPriceDbl <= expectedPriceDb2);//250.00
